        ...
        return json.dumps(
            {
                ...
                "minimax_image_model": settings.minimax_image_model,
                "minimax_api_region": settings.minimax_api_region,
                ...
                "has_minimax_api_key": settings.minimax_api_key is not None,
