...
- [Bernstein Multi-Agent Orchestrator](advance_ai_agents/bernstein_multi_agent_orchestrator) - Deterministic orchestrator that spawns parallel coding agents, verifies with tests, and auto-commits. Zero LLM tokens on coordination
