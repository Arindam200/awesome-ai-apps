...
- [WFGY 16 Problem Map · RAG Failure Clinic](rag_apps/wfgy_llm_debugger) - TXT-based checklist that probes 16 reproducible RAG failure modes on any Nebius-hosted model
